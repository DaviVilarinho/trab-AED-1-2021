...
int main()
{
    int op,op1,FLAG = 0; // FLAG contabiliza a qtde de reinicializa��es da lista
    Lista L, L1, L2;
    ...
    do{
        ...
        case 6: {
            printf("\nQual lista voce quer imprimir 1 ou 2: ");
            scanf("%d",&op1);
        ...
        case 7: {
            printf("\nQual lista voce quer remover os elementos negativos 1 ou 2: ");
            scanf("%d",&op1);
        ...
        case 8: {
            printf("\nQual lista voce quer remover os elementos pares 1 ou 2: ");
            scanf("%d",&op1);
        ...
        case 9: {
            printf("\nQual lista voce quer imprimir o tamanho 1 ou 2: ");
            scanf("%d",&op1);
